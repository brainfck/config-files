...
vim.keymap.set("n", "<Leader>l", ":ToggleTerm<CR>", { silent = true })
vim.keymap.set('t', '<Leader><Esc>', "<C-\\><C-n>:q!<CR>", {silent = true})
...
local has_formatter = { "sumneko_lua" }
